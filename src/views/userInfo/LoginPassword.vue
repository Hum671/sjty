...
import { saveLoginPassword } from '@/api/userInfo'
...
<template>
  <div class="password-box">
    ...
    <div class="content">
      <div v-if="userInfo?.password" class="item">
        <div class="label">{{ $t('h5.password.old_login_password') }}</div>
        <div class="inp">
          <input
            v-model="data.oldPassword"
            :type="showOldPassword ? 'text' : 'password'"
            :placeholder="`${$t('h5.real.Please_enter')}${$t('h5.password.old_login_password')}`"
          />
          <div
