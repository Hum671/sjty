...
watch(currencyMarketDataList, (value) => {
  ...
  if (find) {
    data.value = {
      ...data.value,
      currentPrice: String(find.data?.tick.lastPrice),
    }
  }
})
    ...
    <template v-if="!loading && data">
      ...
      <div class="o-list">
        ...
        <div class="item">
          ...
          <div class="value">{{ Number(data.buyPrice) }}</div>
        </div>

        <template v-if="data.status === 1">
          <div class="item">
            <div class="name">{{ $t('h5.contract.index.current_price') }}</div>
            <div class="value">{{ Number(data.currentPrice) }}</div>
          </div>
          <div class="item">
          ...
          <div class="item">
            ...
            <div class="value">{{ Number(data.number) }}U</div>
          </div>
        </template>
        ...
        <template v-else>
          <div class="item">
            ...
            <div class="value">{{ Number(data.closePrice) }}</div>
          </div>
          <div class="item">
          ...
          <div class="item">
            ...
            <div class="value">
              ...
              <span v-else class="red">{{ Number(data.gain) }}</span>
            </div>
          </div>
        </template>
      </div>
